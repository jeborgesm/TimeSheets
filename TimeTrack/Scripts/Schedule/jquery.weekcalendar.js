	    ...
	    _renderCalendar : function() {
	        ...
	        if(options.buttons) {
	            calendarNavHtml = "<div class=\"calendar-nav\">\
	                <button class=\" btn ui-state-default ui-corner-all today\">" + options.buttonText.today + "????</button>\
	                <button class=\"btn ui-state-default ui-corner-all prev\">" + options.buttonText.lastWeek + "</button>\
	                <button class=\"btn ui-state-default ui-corner-all next\">" + options.buttonText.nextWeek + "</button>\
	                </div>";
