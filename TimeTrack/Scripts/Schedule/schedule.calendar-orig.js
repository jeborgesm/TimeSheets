...
$(document).ready(function() {
    ...
    $calendar.weekCalendar({
        ...
        eventClick: function(calEvent, $event) {
            ...
            var productField = $dialogContent.find("select[name='product']");
    ...
    function getEventData() {
        ...
        var jsondta;
        //jsondta = "{events: [{'id':1, 'start':'2009-07-10T13:15:00.000+10:00', 'end':'2009-07-10T14:15:00.000+10:00', 'title':'Lunch with Mike'}]}";

        //        jQuery.getJSON(virtpath + 'Schedule/getEventData/' + dte, {}, function(json) {
        //            $calendar.weekCalendar.data = json;
        //            $calendar.weekCalendar("refresh");
        //        });

        //        jQuery.ajax({
        //            url: virtpath + 'Schedule/getEventData/' + dte,
        //            success: function(data) {
        //                $calendar.
        //                $calendar.weekCalendar(”refresh”); 
        //                //jsondta = data;
        ...
        //        alert(jsondta);
        //        return jsondta;
        //            url: virtpath + 'Schedule/getEventData/20090710',
        //            type: 'GET',
        //            success: function(data) {
        //return data;
        //return { events: [{ "id": 1, "start": new Date(year, month, day, 10), "end": new Date(year, month, day, 11), "title": "Lunch with Mike"}] };
        //            }
        //        });
